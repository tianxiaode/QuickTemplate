            ...
            describe("Common.oidc.TokenClient", () => {
                ...
                describe("exchangeCode", () => {
                    it("should have clientId", async () => {
                        ...
                        // act
                        await expectAsync(subject.exchangeCode({ code: "code", code_verifier: "code_verifier" })).toBeRejectedWithError();
                    });
                    ...
                    it("should have code", async () => {
                        // act
                        await expectAsync(subject.exchangeCode({ code: "", code_verifier: "code_verifier" })).toBeRejectedWithError();
                    });
            
                    it("should have code_verifier", async () => {
                        // act
                        await expectAsync(subject.exchangeCode({ code: "code", code_verifier: "" })).toBeRejectedWithError();
                    });
