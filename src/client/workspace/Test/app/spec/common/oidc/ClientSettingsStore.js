Ext.define('Test.spec.common.oidc.ClientSettingsStore', {
    ...
    statics: {
        run() {
            describe('Common.oidc.ClientSettingsStore', () => {

                describe("clientId", () => {
                    it("should return value from initial settings", () => {
                        // act
                        let subject = Ext.create('oidc.clientsettingsstore', {
                            authority: "authority",
                            clientId: "client",
                ...
                describe("filterProtocolClaims", () => {
                    ...
                    it("should return value from initial settings", () => {
                        ...
                        // act
                        subject = Ext.create('oidc.clientsettingsstore', {
                            authority: "authority",
                            clientId: "client",
                            redirectUri: "redirect",
