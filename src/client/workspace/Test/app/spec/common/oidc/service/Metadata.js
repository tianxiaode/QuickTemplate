Ext.define('Test.spec.common.oidc.service.Metadata', {
    requires: [
    ...
    statics: {
        run() {
            describe('Common.oidc.service.Metadata', () => {
                let settings;
                let subject;
                ...
                beforeEach(() => {
                    ...
                    subject = Ext.create('oidc.service.metadata', Ext.create('oidc.setting.client', settings));
                });
