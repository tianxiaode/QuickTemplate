Ext.define('Test.spec.common.oidc.service.UserInfo', {
    requires: [
    ...
    statics: {
        ...
        run(){
            describe("Common.oidc.service.UserInfo", () => {
                let subject;
                let metadataService;
                let jsonService;
                ...
                beforeEach(() => {
                    ...
                    subject = Ext.create('oidc.service.userinfo', settings, metadataService);
