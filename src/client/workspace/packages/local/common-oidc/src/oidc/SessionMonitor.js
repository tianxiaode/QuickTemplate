Ext.define('Common.oidc.SessionMonitor',{
    ...
    //             Logger.debug(me, "sessionState", sessionState, ", sub", me.sub);
    //         }
    //         else {
    //             me.sub = undefined;
    //             me.sid = undefined;
    //             Logger.debug(me, "sessionState", sessionState, ", anonymous user");
    //         }
    ...
    //             if (url) {
    //                 Logger.debug(me, "initializing check session iframe");
    ...
    //             }
    //             else {
    //                 Logger.warn(me, "no check session iframe found in the metadata");
    //             }
    //         }
    //         catch (err) {
    //             // catch to suppress errors since we're in non-promise callback
    //             Logger.error(me, "Error from getCheckSessionIframe:", err instanceof Error ? err.message : err);
    //         }
    //     },
    ...
    //                         Logger.debug(me, "same sub still logged in at OP, restarting check session iframe; session_state", session.sessionState);
    //                     }
    //                     else {
    //                         Logger.debug(me, "same sub still logged in at OP, session state has changed, restarting check session iframe; session_state", session.sessionState);
    //                         userManager.events.raiseUserSessionChanged();
    //                     }
    //                 }
    //                 else {
    //                     Logger.debug(me, "different subject signed into OP", session.sub);
    //                 }
    //             }
    //             else {
    //                 Logger.debug(me, "subject no longer signed into OP");
    //             }
    ...
    //                 }
    //             } else {
    //                 Logger.debug(me, "no change in session detected, no event to raise");
    //             }
    //         }
    //         catch (err) {
    //             if (me.sub) {
    //                 Logger.debug(me, "Error calling queryCurrentSigninSession; raising signed out event", err);
    //                 userManager.events.raiseUserSignedOut();
    //             }
    //         }
    //     }
