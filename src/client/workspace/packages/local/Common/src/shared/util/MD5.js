Ext.define('Common.shared.util.MD5', {
    ...
    get: function(s, raw, hexcase, chrsz) {
        var core_md5 = MD5.core_md5,
            str2binl = MD5.str2binl;
        raw = raw || false;
        hexcase = hexcase || false;
        chrsz = chrsz || 8;
        return raw ? MD5.binl2str(core_md5(str2binl(s, chrsz), s.length * chrsz), chrsz) : MD5.binl2hex(core_md5(str2binl(s, chrsz), s.length * chrsz), hexcase);
    }
